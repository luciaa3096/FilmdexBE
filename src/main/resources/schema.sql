-- =======================================================
-- SECUENCIAS COMPATIBLES CON ORACLE 11g
-- =======================================================
-- Se crean secuencias independientes para simular el auto-incremento
-- Iniciamos en 100 (o 1000000 en películas) para evitar colisiones con los datos semilla.
CREATE SEQUENCE persons_seq START WITH 100 INCREMENT BY 1;
CREATE SEQUENCE movies_seq START WITH 1000000 INCREMENT BY 1;
CREATE SEQUENCE users_seq START WITH 100 INCREMENT BY 1;
CREATE SEQUENCE reviews_seq START WITH 100 INCREMENT BY 1;
